...
$filleBySalon = $salonManager->selectFilleBySalon("Villa Loca");
$dataSalon = $salonManager->selectSalonById(1);
              ...
              <div class="post row">
                <div class="col-lg-12 post-content">
                  <div class="blog-post-img">
                    <img src="img/loca.png" alt="" class="main-photo">
                  </div>
                  ...
                  <a href="http://www.lavillaloca.be/"><button class="btn dark">Saber Mas</button></a>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="sidebar">
              ...
              <div class="sidebox widget">
                <h5 class="widget-title">Las masajistas en la casa de <?php $dataSalon['nom']; ?></h5>
