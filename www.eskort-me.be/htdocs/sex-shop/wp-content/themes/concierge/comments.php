...
if(have_comments()){ ?>
	...
	<h5 class="post-comments-title">		
		...
		<?php 
			...
			comments_number( __('No Comment','concierge'), __(' 1 Comment','concierge'), __(' % Comments','concierge'));
	...
	<ul class="custom-list comments">
		...
		<?php 
			...
			$args = array(
					...
					'walker' => new concierge_comment_walker,
			        'style' => '',
			        'callback' => null,
			        'end-callback' => null,
			        'type' => 'all',
...
if(!comments_open() && !is_page() && post_type_supports(get_post_type(), 'comments')){ ?>
	...
	<p>
		<?php _e('comments are closed .','casa') ?>	
	</p>
