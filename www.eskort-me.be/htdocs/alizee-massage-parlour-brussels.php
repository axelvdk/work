...
/*$description = utf8_encode("Most of our masseuses are available from 11 to 20h. Some of them are available up to 22h or by appointment Midnight taken before 22h . Please contact us for more information. Warning! Sunday : only open by appointment taken the day before to a precise masseuse. Be the privileged Sunday ");
$salonManager->updateSalonDescriptionEn($description,5);*/
?>
<!DOCTYPE html>
<html lang="en-us">
  <head>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="sidebar">
              ...
              <div class="sidebox widget">
				...
				{?>
                  <li><a href="<?php echo "/escorte-massage-tantrique-bruxelles-".$filleBySalon[$i]['nom']."-".$filleBySalon[$i]['id_fille']; ?>"><?php echo $filleBySalon[$i]['id_fille'];?> Escort bruxelles</a></li><?php 
				}
				?>
