...
$filleBySalon = $salonManager->selectFilleBySalon("Sweetness");
$dataSalon = $salonManager->selectSalonById(2);
              ...
              <div class="post row">
                <div class="col-lg-12 post-content">
                  <div class="blog-post-img">
                    <img src="img/single_post-main2.png" alt="" class="main-photo">
                  </div>
                  ...
                  <p><?php echo utf8_decode($dataSalon['description_fr']);?></p>
