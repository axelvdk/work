            ...
            <div class="single-post">
              <div class="post row">
                <div class="col-lg-12 post-content">
                  ...
                  <a href="http://www.lavillaloca.be/"><button class="btn dark">More information</button></a>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="sidebar">
              ...
              <div class="sidebox widget">
                <h5 class="widget-title">Masseuses in the massage parlour <?php $dataSalon['nom'];?></h5>
