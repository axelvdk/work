...
$filleBySalon = $salonManager->selectFilleBySalon("Mademoiselle X");
$dataSalon = $salonManager->selectSalonById(9);
/*$description = utf8_encode("Tantric massage is first breath of life . This Eastern philosophy aims to free the body of all its muscle tension and the spirit of all stress. Spiritually it stimulates the imagination and makes sympathetic to meditative practices. We offer various formulas to adapt better to your expectations and needs.");
$salonManager->updateSalonDescriptionEn($description,9);*/
?>
<!DOCTYPE html>
<html lang="en-us">
  <head>
