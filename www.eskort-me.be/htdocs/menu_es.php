                            ...
                            <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 col-lg-offset-4 col-md-offset-2 header-right">
                                ...
                                <div class="header-login">
                                    <button class="header-btn">
                                        <i class="fa fa-key"></i>Loguearse</button>
                                    <div class="header-form">
                                        <form action="index.html" class="default-form">
                                            <p class="alert-message warning">
                                                <i class="ico fa fa-exclamation-circle"></i>Todos estan necessitos !
                                            ...
                                            <p class="form-row">
                                                <input class="required" type="password" placeholder="Contraseña">
                                            </p>
                                            <p class="form-row">
                                                <button class="submit-btn btn light">Loguearse</button>
                                            </p>
											<p class="form-row">
                                ...
                                <div class="header-language">
                                    <button class="header-btn">
                                        <i class="fa fa-globe"></i>ES</button>
                                ...
                                <nav role="navigation">
                                    <ul class="nav navbar-nav">
                                        <li class="has-submenu">
                                            <a href="index_es.php">Escortes</a>
                                        </li>
                                        <li class="has-submenu">
                                            <a href="adresses_es.php">Agenda de direcciones</a>
                                        </li>
                                        <li>
                                            
<a class="typeform-share" href="https://clement4.typeform.com/to/BQyEKE" data-mode="1"target="_blank"><i class="fa fa-lock"> Registro</i></a></li>
                                     </ul>
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="has-submenu">
                                            <a href="about_es.php">El concepto</a>
                                            
                                           
                                        
                                        <li class="has-submenu">
                                            <a href="contact_es.php">Contacto</a>
