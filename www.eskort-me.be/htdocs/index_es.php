...
<?php if(!isset($_SESSION)) session_start();
	...
	$_COOKIE['langue']="fr";
	if(!isset($_SESSION['nb_refresh_es']))
	{
		$_SESSION['nb_refresh_es']=0;
	}
	else
	{
		$_SESSION['nb_refresh_es']++;
		if(isset($_SESSION['random_es']))
		{
			if(!isset($_GET['action']))
			{
				$_SESSION['random_es']=$_SESSION['recorded_random_es_selectAll'];
			}
			elseif($_GET['action']=='filtres')
			{
				$_SESSION['random_es']=$_SESSION['random_es_selectFiltres'];
			}
			elseif($_GET['action']=='recherche_nom')
			{
				$_SESSION['random_es']=$_SESSION['random_es_rechercheNom'];
			}
		}
	}
	
	if($_SESSION['nb_refresh_es']==0)
	{
		$_SESSION['random_es'] = $filleManager->selectAll();
		$_SESSION['recorded_random_es_selectAll']=$_SESSION['random_es'];
	}
	...
	if(isset($_POST['action']))
	{
		...
		{
			$_SESSION['random_es']=$filleManager->selectFilleByNom($_POST['nom']);
			$_SESSION['random_es_rechercheNom']=$_SESSION['random_es'];
		}
		elseif($_POST['action']=='filtres')
		{
			...
			$_SESSION['random_es'] = $filleManager->selectFilleFiltre($criteres);
			$_SESSION['random_es_selectFiltres'] = $_SESSION['random_es'];
		}
	}
...
<html lang="es">  
    <head>
        ...
        <link rel="canonical" href="http://www.eskort-me.be/index_es.php">
   ...
   <a href="http://www.sweetness-massage.be/"> <img src="img/sweetness.png" alt="Sweetness, Salon de massage tantrique à bruxelles"/></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="fleets-listing-header clearfix">
                            ...
                            <h5>PASSA UN MOMENTO AGRADABLE CON </h5>
      ...
      <div class="header-title-inner">
        <div class="container">
            ...
            <a href="index_es.php" title="Retour à l'accueil">Pagina de Inicio</a> /
      ...
      <!-- End Header-Title-Inner -->
                <div class="container">
                    <center><h3>NUESTRAS MASAJISTAS</h3></center>
            ...
            <!-- End Header-Title-Inner -->
                    ...
                    <div class="col-lg-3">
                        <div class="fleets-filters toggle-container">
                            <h5 class="fleets-filters-title toggle-title">Preferencias</h5>
                            ...
                            <aside class="toggle-content">
                                ...
                                <form action="index_es.php" method="POST" id='form_filtre'>
                                ...
                                <div  class="default-form">
                                        ...
                                        <div class="fleets-capacity box-row">
                                            <h5 class="filter-title">Mensurationes</h5>
                                             <span>Pecho</span>
                                            <p class="form-row">
                                            ...
                                            <span class="people select-box col-lg-9">
                                                    <select name="poitrine" data-placeholder="Indiferente">          
                                                        <option value="Tous">Indiferente</option>
                                                        <option value="Petits">Pequenos</option>
                                                        <option value="Moyens">Medios</option>
                                                        <option value="Gros">Gordos</option>
                                ...
                                <div class="fleets-search-filter">
                                    <div class="default-form">
                                        ...
                                        <div class="slider-range-container box-row">
                                            <span>Talla <small>(cm)</small></span>
                                ...
                                <!-- End Propeties Search Filter -->
                                    <br/>
                                        ...
                                        <!-- Start Propities Capacity -->
                                        <div class="fleets-capacity box-row">
                                            <h5 class="filter-title">Preferencias</h5>
                                              <!-- <span>Origines</span>
                                           
                                                <span>Salones <small>(Brusselas)</small></span>
												<?php $filleManager = new FilleManager();
													 $result = $filleManager->selectSalon();
													 ?>
                                           <span class="people select-box col-lg-9">
                                                    <select name="salons" data-placeholder="Todos"> 
                                    ...
                                    <br/>
                                     <div class="default-form">
                                        ...
                                        <div class="fleets-capacity box-row">                          
                                            ...
                                            <span class="people select-box col-lg-9">
                                                    <select name="peau" data-placeholder="Indiferentes">
														<option value="Tous">Indiferentes</option>
                                                        <option value="Blanche">Bianca</option>
                                                        <option value="Bronzee">Bronceada</option>
                                                        <option value="Couleur cafe">Color Café</option>
                                                        <option value="Noire">Negra</option>
                                                    </select>
                                                </span>
                                ...
                                <div class="fleets-search-filter">
                                    <div class="default-form">
                                        ...
                                        <input type="submit" class="btn dark" value="Buscar" />
                                    </form>
                                    
                                    <br /><br />
                                    
                                    <button class="btn dark" id="clear">Eliminar Búsqueda</button>
       ...
       <?php require_once("footer_es.php");?>         <!--  </div>
                  pop up
