...
//la page?><h1>Transport</h1><p>Nous vous proposons divers moyens de livraison pour votre plus grande facilit�. Nous privilegions l'utilisation
  ...
  <form action="<?php echo './fr-pg72-'. $site . '.html';?>" method="post" id="transport" name="transport" />    <input type="hidden" name="dossier_livraison" value="ok"/>
    <p>
...
<div id="results_html_delai"> </div>  </div>
  ...
  <div id="divtransp_mr" style="display:none;">      <?php
      if(isset($_SESSION['charge_client'])) echo "la charge : ".$_SESSION['charge_client'];
