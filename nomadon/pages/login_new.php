...
// on traite directement avec les variables en get et on affiche le resultat
    ...
    $client_pw_confirmation = ClientFactory::Client_Change_PW_Confirmation('valide', $_POST['login'], $_POST['ctrl'], $_POST['pw1'], $_POST['pw2'],$lang);
} elseif ($_REQUEST['action'] == '0') {
    include_once './class/autoload.php';


    $client_pw_confirmation = ClientFactory::Client_Change_PW_Confirmation('annulation', $_GET['login'], $_GET['ctrl'], $_POST['pw1'], $_POST['pw2'],$lang);
}
