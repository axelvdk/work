...
*/
 ...
 ';
     ...
     echo'</p>';
        echo'<p>';
      echo'<a href="./'.$_SESSION['lang'].'-pg85-'.$site.'.html">'.$lang_loginperdu[$lang].'</a>';
      echo'</p>';

       echo'<p>';
      echo'<a href="./'.$_SESSION['lang'].'-pg81-'.$site.'.html">'.$lang_enregistrer[$lang].'</a>';
      echo'</p>';
