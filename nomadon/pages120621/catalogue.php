...
if ($categorie_presente == 1) {
    ...
    foreach ($element as $values) {
        ...
        if ($values->getType_element() == 'cat') {
            ...
            $lien = Utilitaires::lien('2', $lang, $site, $ariane, $values->getId_element(), $values->getRef_element());
...
$lien_art = Utilitaires::lien('21', $lang, $site, $ariane, $values->getId_element(), $values->getRef_element());
                ...
                echo'</div>';
                echo'<p>';
                $prix0=$values->getPrix();
                echo'<a href="./' . $lien_art . '">' . $values->getNom_element() . '</a></p>';
                echo'<p><a href="./' . $lien_art . '">' . $values->getRef_element() . ' - ' . $prix0[0] . ' &euro; ' . $values->getUnite . '</a></p>';
