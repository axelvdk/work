...
if ($_POST['action'] == '1') {
    ...
    $panier = PanierFactory::consulterPanier();
     ...
     header("Location: ./".$lang."-pg7-festi-rent.html");
...
echo'</fieldset>';
echo'<p>';
echo'<input style="margin:0 0 0 0;float:left;border:none" type="image" title="' . $lang_valider[$lang] . '" alt="' . $lang_valider[$lang] . '" name="submit" src="./img/valider.png">';

echo'<a href="./fr-pg7-' . $site . '.html"><img src="./img/annuler.png" style="margin-top:18px;float:left;border:none" alt="'.$lang_annuler[$lang].'" title="'.$lang_annuler[$lang].'"></a>';
