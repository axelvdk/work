...
echo'<script type="text/javascript" charset="utf-8">google.load("jquery", "1.3");</script>';
echo'<script src="scripts/jquery.prettyPopin.js" type="text/javascript" charset="utf-8"></script>';
echo'<script type="text/javascript" charset="utf-8">

    $(document).ready(function(){

       $("a[rel^=\'prettyPopin_home\']").prettyPopin(
        {
       ...
       $("a[rel^=\'prettyPopin_test\']").prettyPopin(
        {
            modal : false, /* true/false */            
            width : 600, /* false/integer */
            height: false, /* false/integer */
...
echo'<a href="http://www.bruxelles-export.be"><img src="./img/bxlex.jpg" title="' . $lang_awex . '" alt="' . $lang_awex . '"  width="100" /></a>';
