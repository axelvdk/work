    ...
    <div class="secondary-navigation-wrapper">
        <div class="container">
            ...
            <ul class="secondary-navigation list-unstyled pull-right">
				...
				<li><a href="http://localhost/mbacenter/mbacenter/managers/deconnecter.php">Log Out</a></li>
                            ...
                            <section id="my-profile">
                                ...
                                <div class="my-profile">
                                    ...
                                    <article>
                                        ...
                                        <button type="button" class="btn pull-right" id="btn_save_change">Save Changes</button>
                                    </article>
                                </div><!-- /.my-profile -->
                            </section><!-- /#my-profile -->
                        </div><!-- /tab-pane -->
