...
if(!isset($_SESSION['id_user'])) header("location: http://localhost/mbacenter/mbacenter/index.php");
?>
                            ...
                            <section id="event-header">
                                ...
                                <div class="course-count-down" id="course-count-down">
                                    ...
                                    <div class="count-down-wrapper">
                                        <script type="text/javascript">var _date = '2015-01-28'; var _cours="1-2-1 meetings with top Business School" </script>
