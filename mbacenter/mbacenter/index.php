...
if(isset($_SESSION['user'])||isset($_SESSION['employe']))
{
	?><input type="hidden" id="session_active" value="<?php echo true ?>"/><?php
}
?>
<!DOCTYPE html>
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="list-unstyled child-navigation">
                                <li><a <?php if(isset($_SESSION['user'])||(isset($_SESSION['employe']))){?> href="college.html" <?php }else{ ?> href="#" <?php } ?>>College</a></li>
                                <li><a <?php if(isset($_SESSION['user'])||(isset($_SESSION['employe']))){?> href="business_school.html" <?php }else{ ?> href="#" <?php } ?>>Business School</a></li>
                                <li><a <?php if(isset($_SESSION['user'])||(isset($_SESSION['employe']))){?> href="graduate.html" <?php }else{ ?> href="#" <?php } ?>>Graduate School</a></li>
                        ...
                        <li>
                            ...
                            <ul class="list-unstyled child-navigation">
                                <li><a <?php if(isset($_SESSION['user'])||(isset($_SESSION['employe']))){?> href="calendar.html" <?php }else{ ?> href="#" <?php } ?> >Calendar</a> </li>
                    ...
                    <div class="slider-content">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form id="slider-form" role="form" action="slider-form" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                ...
                                <div class="tab-content course-tab-content">
                                    ...
                                    <div class="tab-pane fade" id="tab-TOEFL">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/SIg2VrnW8mg" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                    ...
                                    <div class="tab-pane fade" id="tab-IELTS">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/91vt4Xclkug" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                    ...
                                    <div class="tab-pane fade" id="tab-SAT">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/Sd6I0wx85mA" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                    ...
                                    <div class="tab-pane fade" id="tab-Solvay">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/Eco4z98nIQY" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                     ...
                                     <div class="tab-pane fade" id="tab-Vlerick">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/boN-R3Xgqww" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                     ...
                                     <div class="tab-pane fade" id="tab-TOEIC">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/kdemFfbS5H0" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                    ...
                                    <div class="tab-pane fade" id="tab-TAGE">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/lOT3BvhjXcA" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                     ...
                                     <div class="tab-pane fade" id="tab-GRE">
                                        ...
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/Tii2hZM40V8" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
                                     ...
                                     <div class="tab-pane fade" id="tab-IEGAT">
                                       <!--IEGAT CONTENT-->
                                        <section>
                                          <div class="section-content col-md-6 col-sm-10">
											  <div class="row">
												  <p><iframe width="100%" height="300" src="//www.youtube.com/embed/uI8NlSP7tOI" frameborder="0" allowfullscreen></iframe></p>
												  	</div> 
												  		</div>
...
<br/>
                            ...
                            <p><a href="college.html" class="btn btn-small fa fa-plus"> College</a>
                             <a href="business_school.html" class="btn btn-small fa fa-plus"> Business School</a></p><p><a href="graduate.html" class="btn btn-small fa fa-plus"> Graduate School</a></p>
           ...
           <div class="col-md-6 col-sm-12">
            ...
            <div class="col-md-6 col-sm-6">
                <section class="events small" id="events-small">
                    <header>
                        <h2>Events</h2>
                        <a href="calendar.html" class="calen" id="calendar_link"><h2> Calendar </h2></label> 
                    </header>
                    <div class="section-content">
                        <article class="event nearest">
                            ...
                            <aside>
                                <header>
                                    <a href="gmat.html">GMAT Kit: Free assessment of your GMAT level</a>
                                </header>
                        ...
                        <article class="event nearest-second">
                            ...
                            <aside>
                                <header>
                                    <a href="school-event.html"> Said Business Information session Brussels</a>
                                </header>
                        ...
                        <article class="event">
                            ...
                            <aside>
                                <header>
                                    <a href="school-event3.html">January 28th 1-2-1 meetings with Top B-Schools</a>
                                </header>
                    ...
                    <div class="section-content">
                        <div class="professors">
                            ...
                            <article class="professor-thumbnail">
                                ...
                                <aside>
                                    <header>
                                        <a href="#">Laurène Daniel</a>
                                        <div class="divider"></div>
                                        <figure class="professor-description">Sales Manager</figure>
                                    </header>
                                    <a href="http://www.clementh.com" class="show-profile">Show Profile</a>
